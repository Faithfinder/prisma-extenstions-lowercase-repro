...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/home/misamoto/Source/OpenSource/prisma-extenstions-lowercase-repro/prisma/built",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
path.join(process.cwd(), "prisma/built/libquery_engine-debian-openssl-1.1.x.so.node")
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/built/schema.prisma")
